...
tmax = 50
mejor = None
tasaExacto = optimo / tiempoExacto
tasaGenetico = []
start = time()
tiempo = 0
while tiempo < tiempoExacto:
    ...
    tiempo = time() - start
    tasaGenetico.append(mejor / tiempo)
 
import matplotlib.pyplot as plt
  
plt.figure(figsize=(7, 3), dpi=300)
plt.plot(range(len(tasaGenetico)), tasaGenetico, 'ks--', linewidth=1, markersize=5)
plt.axhline(y = tasaExacto, color = 'green', linewidth=3)
plt.xlabel('Paso')
plt.ylabel('Valor por unidad de tiempo')
